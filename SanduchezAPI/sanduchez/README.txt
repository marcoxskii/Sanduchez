...
a persistence unit "sanduchezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sanduchez/pom.xml":
...
artifact ("sanduchez.war") is already built. You can build
